...
public class CompraController {
    ...
    @PostMapping
    public ResponseEntity<CompraResponseDTO> criarCompra(@RequestBody CompraRequestDTO compraRequestDTO) {
        CompraResponseDTO compra = compraService.criarCompra(compraRequestDTO);
